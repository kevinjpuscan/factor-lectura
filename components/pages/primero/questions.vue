<template>
  <div>
    <ContainterQuestions>
      <Wrapper>
        ...
        >
          ...
          />
          <alternative-multiple :alternatives="question.alternatives" />
        </card-question>
      </Wrapper>
    </ContainterQuestions>
    <ImageSection />
    <ContainterQuestions>
      <Wrapper>
        <card-question
          v-for="(question, index) in questionsSecondary"
          class="card"
          :key="index"
        >
          <text-question
    ...
    <ContainterQuestions>
      <Wrapper>
        <card-question class="card">
          <text-question number="1" question="Seguro?" />
          <option-text />
        </card-question>
      </Wrapper>
    </ContainterQuestions>
...
<script>
import ContainterQuestions from "../../shared/ContainerQuestions";
import CardQuestion from "../../shared/CardQuestion";
  ...
  data: () => ({
    questionsMain: [
      ...
      },
      {
        number: "2",
        question:
          "2.	El transportista que contó la historia en el texto leído fue:",
        alternatives: [
